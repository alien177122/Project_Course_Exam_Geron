...
const deleteTariffNameSpan = document.getElementById("deleteTariffName");
const addTariffBtn = document.getElementById("addTariffBtn");
const cancelAddBtn = document.getElementById("cancelAdd");
const cancelEditBtn = document.getElementById("cancelEdit");
const cancelDeleteBtn = document.getElementById("cancelDelete");
const confirmDeleteBtn = document.getElementById("confirmDelete");
const addLicensesInput = document.getElementById("addLicenses");
const addTracksInput = document.getElementById("addTracks");
const editLicensesInput = document.getElementById("editLicenses");
const editTracksInput = document.getElementById("editTracks");
...
function calculatePrice(licenses, tracks) {
...
const calculateFormPrice = (licenses, tracks) => {
...
function addTariff(name, price, licenses, tracks) {
    const newTariff = {
        id: nextId++,
        name: name,
        price: price,
...
function updateTariff(id, name, price, licenses, tracks) {
    const tariff = tariffs.find((t) => t.id === id);
    if (tariff) {
        tariff.name = name;
        tariff.price = price;
...
let currentServiceDeleteId = null;
...
const editServicePriceInput = document.getElementById("editServicePrice");
...
const closeEditServiceModalBtn = document.getElementById("closeEditServiceModal");
...
const cancelDeleteServiceBtn = document.getElementById("cancelDeleteService");
...
serviceSearchInput.addEventListener("input", () => renderServiceTable(serviceSearchInput.value));
...
cancelAddServiceBtn.addEventListener("click", () => closeModal(addServiceModal));
closeEditServiceModalBtn.addEventListener("click", () => closeModal(editServiceModal));
cancelEditServiceBtn.addEventListener("click", () => closeModal(editServiceModal));
cancelDeleteServiceBtn.addEventListener("click", () => closeModal(deleteServiceModal));
...
links.forEach((link) => {
    link.addEventListener("click", (event) => {
        ...
        if (targetId === "login") {
            (_a = document.getElementById("login")) === null || _a === void 0 ? void 0 : _a.classList.add("active");
        }
        else {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    loginForm.addEventListener("submit", (e) => {
        e.preventDefault();
        const uname = loginForm.elements.namedItem("username")
            .value;
        const pass = loginForm.elements.namedItem("password")
            .value;
    ...
    logoutBtn === null || logoutBtn === void 0 ? void 0 : logoutBtn.addEventListener("click", () => {
        ...
        // Очищаем пароль
        const pwd = loginForm.elements.namedItem("password");
        if (pwd)
            pwd.value = "";
